...
// CORS dinâmico: permite configurar origens via variável de ambiente
// Exemplo: ALLOWED_ORIGINS="https://meuusuario.github.io,https://outro.dominio.com"
$default_origins = [
...
if (in_array('*', $allowed_origins, true)) {
    ...
    // Mantém compatibilidade com comportamento anterior: usa primeiro domínio como padrão
